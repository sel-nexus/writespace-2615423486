...
export default function Avatar({ role, small = false }) {
  return (
    <span
      aria-label={role === 'admin' ? 'Administrator avatar' : 'Writer avatar'}
      className={`${role === 'admin' ? 'bg-violet-600' : 'bg-indigo-500'} inline-flex ${
